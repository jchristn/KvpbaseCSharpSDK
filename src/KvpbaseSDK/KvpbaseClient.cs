...
using RestWrapper;
using ISerializationHelper = KvpbaseSDK.Classes.ISerializationHelper;
...
namespace KvpbaseSDK
{
	...
	public class KvpbaseClient
    {
        ...
        private ISerializationHelper _SerializationHelper = new KvpbaseSDK.Classes.DefaultSerializationHelper();
        ...
        public async Task<List<string>> ListContainers(CancellationToken token = default)
        {
            try
            {
                ...
                if (resp.Data != null && resp.ContentLength > 0)
                {
                    ...
                    return SerializationHelper.DeserializeJson<List<string>>(data);
                }
        ...
        public async Task CreateContainer(string container, bool publicRead = false, bool publicWrite = false, bool auditLogging = false, CancellationToken token = default)
        {
            ...
            try
            {
                ...
                RestResponse resp = await req.SendAsync(SerializationHelper.SerializeJson(settings, false), token).ConfigureAwait(false);
        ...
        { 
            ...
            try
            {
                ...
                if (resp.Data != null && resp.ContentLength > 0)
                {
                    ...
                    return SerializationHelper.DeserializeJson<Container>(data);
                }
        ...
        public async Task<Dictionary<string, string>> GetContainerKeyValuePairs(string container, CancellationToken token = default)
        {
            ...
            try
            {
                ...
                {
                    data = KvpbaseCommon.StreamToBytes(resp.Data);
                    return SerializationHelper.DeserializeJson<Dictionary<string, string>>(data);
                }
        ...
        public async Task WriteContainerKeyValuePairs(string container, Dictionary<string, string> keyValuePairs, CancellationToken token = default)
        {
            ...
            try
            {
                ...
                {
                    resp = await req.SendAsync(SerializationHelper.SerializeJson(keyValuePairs, true), token).ConfigureAwait(false);
                }
                else
                {
        ...
        { 
            ...
            try
            {
                ...
                if (resp.Data != null && resp.ContentLength > 0)
                {
                    return SerializationHelper.DeserializeJson<ObjectMetadata>(KvpbaseCommon.StreamToBytes(resp.Data));
                }
        ...
        { 
            ...
            try
            {
                ...
                if (resp.Data != null && resp.ContentLength > 0)
                {
                    return SerializationHelper.DeserializeJson<Dictionary<string, string>>(KvpbaseCommon.StreamToBytes(resp.Data));
                }
        ...
        { 
            ...
            if (filter != null)
            {
                data = SerializationHelper.SerializeJson(filter, true);
            ...
            return SerializationHelper.DeserializeJson<ContainerMetadata>(KvpbaseCommon.StreamToBytes(resp.Data)); 
        }
